...
flowchart LR
  ...
  H -. "관심사를 더 구체화" .-> I["/research 전공 아이디어"]
  I --> P
```
...
| 대화 도구 | `/quest` | 현재 교수·저장 카드 | 만나기 전·중·후 도구 | 각 퀘스트 |
| 이메일 | `/quest/email-guard` | 교수·학생 고민 맥락 | 소개·질문·이메일 초안 | 학생 직접 연락 |
| 면담 후 | `/mentor-loop` | 교수 피드백 | 수정 전후·7일 행동 | 성장 기록 |
| 성장 기록 | `/portfolio` | 실제 저장 결과 | 준비·변화 과정 | 재방문 홈 |
| 아이디어 심화 | `/research` | 관심·경험·방법·기간 | 구체화한 주제 후보 | 교수 찾기 |
