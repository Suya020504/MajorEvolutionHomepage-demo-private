...
const HOME_DEPARTMENT_COPY: RoleCopy = {
  label: "같은 학과 연결",
  nickname: "가까운 시작점",
  learning: [
    "우리 학과의 수업·프로젝트 흐름을 질문하는 방법",
    "전공 안에서 세부 분야와 진로 방향을 구분하는 관점",
    "막연한 고민을 같은 학과 맥락의 첫 질문으로 바꾸는 과정",
  ],
  mentorRole: "같은 학과 맥락에서 첫 대화의 문턱을 낮춰 볼 ‘가까운 시작점’",
  pitch: (interest, evidence) =>
    `같은 학과의 공식 소속이 확인된 교수님이라, ‘${interest}’ 고민을 학과 수업과 전공 흐름 안에서 어디서부터 질문할지 살펴보기 좋은 시작점이에요. 공식 연결 근거는 ‘${evidence}’입니다.`,
};
